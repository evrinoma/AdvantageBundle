...
namespace Evrinoma\AdvantageBundle\DtoCommon\ValueObject\Mutable;

use Evrinoma\AdvantageBundle\DtoCommon\ValueObject\Immutable\PositionTrait as ImmutablePositionTrait;
