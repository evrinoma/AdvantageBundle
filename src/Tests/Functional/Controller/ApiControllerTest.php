...
namespace Evrinoma\AdvantageBundle\Tests\Functional\Controller;

use Evrinoma\AdvantageBundle\Fixtures\FixtureInterface;
...
{
    protected string $actionServiceName = 'evrinoma.advantage.test.functional.action.advantage';
    ...
    {
        return [FixtureInterface::ADVANTAGE_FIXTURES];
    }
}
