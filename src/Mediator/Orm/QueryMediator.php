...
class QueryMediator extends AbstractQueryMediator implements QueryMediatorInterface
{
    ...
    protected static string $alias = AliasInterface::ADVANTAGE;
