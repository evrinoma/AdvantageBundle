...
namespace Evrinoma\AdvantageBundle\Facade\Advantage;

use Evrinoma\AdvantageBundle\Manager\CommandManagerInterface;
use Evrinoma\AdvantageBundle\Manager\QueryManagerInterface;
use Evrinoma\AdvantageBundle\PreValidator\DtoPreValidatorInterface;
