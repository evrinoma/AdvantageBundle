...
namespace Evrinoma\AdvantageBundle\Validator;

use Evrinoma\AdvantageBundle\Entity\Advantage\BaseAdvantage;
use Evrinoma\UtilsBundle\Validator\AbstractValidator;
use Symfony\Component\Validator\Validator\ValidatorInterface;

final class AdvantageValidator extends AbstractValidator
{
    /**
     * @var string|null
     */
    protected static ?string $entityClass = BaseAdvantage::class;
